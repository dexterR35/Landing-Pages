...
<form id="inputForm" method="post">
  <div class="BonusCodeText">
    ...
    <div class="line-two">UȘA TA ASCUNDEA <div class="span_code_input"></div></div>
    <div class="line-three">la jocul <div class="span_game_input"></div></div>
  ...
  <div class="input-box box_n0">
    ...
    <div class="emailError" id="emailError" style="display: none;"></div>
  </div>
