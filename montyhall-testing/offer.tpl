...
<style>
  ...
  .BonusCodeText .line-three .span_game_input {
    font-size: 1.2em;
  }
  .wrapper-seven,
  .container-seven {
  ...
  .BonusCodeText .line-two .span_code_input {
    font-size: 1.4em;
  }
  ...
  @media screen and (orientation: landscape) and (min-width: 1200px) and (max-height: 850px) {
    .modal-input {
      transform: scale(0.8);
    }
  }
...
{/block} {include file="{$smarty.current_dir}/game.tpl"}
