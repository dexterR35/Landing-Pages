...
const maxDistance = 200; // Maximum racing distance (in meters)
...
// Define halfMaxDistance as half of maxDistance
// let halfMaxDistance = maxDistance / 2;
...
function update() {
  if (gameStarted) {
    ...
    console.log(carGood.position.y)
    ...
    // Increase background speed every n seconds
    if (
