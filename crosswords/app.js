...
$(document).ready(function () {
    // let words = "steaua,faru,rapid,dinamo,sepsi,paracetamol,netbet,cluj,craiova";
    let words = ["steaua", "rapid", "dinamo", "farul", "arges", "voluntari", "cluj", "galati", "spesi","timisoara","uta","mioveni","craiova","petrolul","targoviste"];
    let textTop = `<div class="text_top">Echipe</div>`
    ...
    const randomValues = indices.map(index => words[index]);
    //attach the game to a div
    $("#theGrid").wordsearchwidget({
        "wordlist": randomValues,
        "gridsize": 14,
        "width": 100
    });

    $("#rf-wordcontainer").prepend(textTop)
