    ...
    const streamerImages = {
        'pacanela': './assets/icons_streamers/testpacanela.webp',
        'streamer2': './images/streamer2.png',  // Add more streamer mappings as needed
        'default': './images/default.png',       // Default image for other streamers
    ...
    function createTableStreamers(streamer) {
        ...
        // Get the image source from the hardcoded object or use default
        const imgSrc = streamerImages[displayName.toLowerCase()] || streamerImages['default'];
