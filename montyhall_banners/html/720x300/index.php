...
<html lang="ro">
  <head>
    ...
    <meta name="ad.size" content="width=720,height=300">
    ...
    top: 4px;
      ...
      .cell_three .logo-netbet {
      background-position: 77px center;
    }
    .cell_four .logo-netbet {
      background-position: 50px center;
    }
    .cell_four .offer-html {
      position: relative;
        left: 47px;
        top: 6px;
    }
            ...
            <div class="cell_text">
              <div class="container-text">
                ...
                <div class="offer-html">
                  <div class="p1__line-1">INTRĂ ÎN </br> UNIVERSUL NETBET!</div>
                </div>
