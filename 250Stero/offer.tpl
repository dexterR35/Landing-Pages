...
<div class="cherry">
  ...
  <div class="girl">
    <img src="{$asset}/stero-new3.png" alt="stero" srcset="" />
  </div>
...
<style>
  body::before {
    background-position: 0 3.5em !important;
  }
  ...
  @media (max-width: 1024px) {
    body::before {
      background-image: url({$asset}/bg-stero-mobile.jpg);
