...
const quizdata = [{
        question: "Când a fost folosit sistemul de arbitraj video (VAR) pentru prima dată la Turneul Final?",
        options: ["În 2010", "În 2018", "În 2022 va fi prima dată"],
        answer: "În 2018",
        infoQ: "Din 2018 până în prezent, VAR a sporit gradul de decizii corecte de la 95% la 99,2%.",
        category: 1,
    },
    {
        question: "Care a fost Campionatul cu cea mai scăzută medie de goluri pe meci?",
        options: ["Mexic 1970", "Italia 1990", "Brazilia 2014"],
        answer: "Italia 1990",
        infoQ: "Coppa del Mondo 1990 a avut o medie de 2,21 goluri pe meci, cea mai mică de până acum. Cu un golaveraj 5-5 în 4 partide, România s-a clasat peste medie la această statistică.",
        category: 2,
    },
    {
        ...
        answer: "Infinit",
        infoQ: "Simbolul infinitului are mai multe conotații, reprezentând cele 8 stadioane participante și legăturile formate ce vor dăinui mult timp după turneu.",
        category: 3,
    },
    {
        question: "Care națională ar putea egala anul acesta recordul de 5 trofee deținut în prezent de Brazilia?",
        options: ["Franța", "Italia", "Germania"],
        answer: "Germania",
        infoQ: "Germania și Italia au câte 4 titluri fiecare, dar numai Germania s-a calificat anul acesta. Franța are 2 titluri câștigate.",
        category: 1,
    },
    {
        ...
        infoQ: "Deși retras, Klose câștigă acest top, cu 16 goluri, urmat de Ronaldo cu 15.",
        category: 2,
    },
    {
        question: "Ce țară participantă are cel mai valoros lot?",
        options: ["Brazilia", "Anglia", "Franța"],
        infoQ: "Cel mai valoros lot îl are Anglia, ce depășește 1 miliard de euro. Brazilia este următoarea pe listă, iar Franța ocupă locul 4.",
        answer: "Anglia",
        category: 3,
    },
    {
        question: "Anul acesta se modifică numărul jucătorilor din loturile naționalelor. Care este noul număr?",
        options: ["30", "26", "24"],
        answer: "26",
        infoQ: "Cu trei mai mulți ca în edițiile precedente, loturile au acum dreptul de a avea 26 de jucători.",
        category: 2,
    },
    {
        ...
        answer: "Jules Rimet",
        infoQ: "Inițial botezat Victoria, trofeul a fost redenumit după președintele organizației din 1929, Jules Rimet.",
        category: 3,
    },
    {
        question: "Cum se numește stadionul temporar, construit din containere?",
        options: [
            "Stadionul 974",
            "Stadionul Education City ",
            "Stadionul Al Janoub",
        ],
        infoQ: "Stadionul 974 este un proiect sustenabil, o construcție temporară ce va fi demolată si refolosită. Numeralul reprezintă prefixul țării gazdă.",
        answer: "Stadionul 974",
        category: 1,
    },
    {
        question: "Care este jucătorul ce poate depăși recordul lui Matthäus la acest turneu?",
        options: ["Cristiano Ronaldo", "Lionel Messi", "Antoine Griezmann"],
        infoQ: "Dintre jucătorii in activitate, Lionel Messi este cel cu șansele cele mai bune, datorită celor 19 prezențe. Ronaldo are 17, iar Griezmann 12.",
        answer: "Lionel Messi",
        category: 2,
    },
    {
        question: "Când a fost pentru prima dată difuzat la televizor Turneul de fotbal?",
        options: ["1954", "1958", "2002"],
        infoQ: "În 1954 a fost difuzat pentru prima oară la televizor C.M. De atunci și până acum a devenit cel mai urmărit eveniment sportive din lume.",
        answer: "1954",
        category: 3,
    },
    {
        question: "Care este naționala ce nu a ratat niciun Turneu Final până în prezent?",
        options: ["Anglia", "SUA", "Brazilia"],
        infoQ: "Brazilia deține acest record, fiind prezentă la fiecare C.M. Are și cele mai multe victorii, cinci la număr.",
        answer: "Brazilia",
        category: 3,
    },
];
